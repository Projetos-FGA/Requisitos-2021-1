...
### 6.5. Gerenciamento de Riscos
&nbsp;
Análise quantitativa dos riscos e Impacto 
| Valor | Impacto | Intervalo | Descrição |
| :----: | :----: | :----: | :----: |
| 1 | Muito Baixo | Menor que 20% | Impacto pouco expressivo no desenvolvimento do projeto |
| 2 | Baixo | de 21% a 40% | Pouco impacto no desenvolvimento do projeto |
...
| :----: | :----: | :----: | :----: | :----: |
| R01 | Planejamento Ineficiente | Alta | Alto | Levantar os pontos falhos o mais rápido possível e corrigir nas próximas iterações |
| R02 | Mudança de escopo | Baixa | Muito Alto | Entender melhor as necessidades e expectivas dos usuários para fazer alterações assertivas no escopo, evitando novas |
| R03 | Problema de comunicação entre os membros da equipe | Média | Baixo | Usar o todos os canais possíveis | 
| R04 | Concentração do conhecimento em poucos membros da equipe | Baixa | Baixo |Identificar membros mais experientes e fazer pareamentos para transferência de conhecimentos |
| R05 | Desistência de Membros | Baixa | Alto | Realocar tarefas entre os membros da equipe |
| R06 | Limitação com as tecnologias | Alta | Alta | Realizar treinamentos e pareamentos com membros mais experientes | 
